...
<div class="flex justify-center items-center h-[100vh]">
    <div class="px-4 w-full max-w-[400px] h-[400px] bg-white flex flex-col ">
        ...
        <form class="flex flex-col text-left mb-8">
            ...
            <h4 class="pt-4 pb-2">Email</h4>
            <div class="border rounded-xl border-[#DBE0E5] h-[56px] flex items-center">
                <input class="pl-4 outline-none bg-transparent font-normal text-sm" type="email" placeholder="Email">
            </div>
            ...
            <button class="mt-4 bg-slate-600 rounded-md w-full h-[35px] text-sm text-white drop-shadow-xl">Sign up</button>
        </form>
        <div class="text-xs">Sudah punya akun? <a class="text-cyan-600" href="/login">Sign in</a></div>
    </div>
</div>
@endsection